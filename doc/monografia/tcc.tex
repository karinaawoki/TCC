...
árvores desse tipo acabam caindo no primeiro caso do Algortimo da 
...
no segundo caso
do Algortimo da dobra do diâmetro, que irá gerar um corte
limitado superiormente por um valor alto.
