...
\section {Complexidade do problema da bissecção 10}
	...
	\subsection{Redução Max Sat2 para SimpleMaxCut}
		...
		\begin{center} \begin{tikzpicture}
			...
			% Base de baixo mais espacada -- espaco=4
			% \node (t0) at (4, 13)  {$T_0$};
			% \node (t1) at (7, 13)  {$T_1$};
			% \node (t2) at (10,13)  {$T_2$};
			% \node (t3) at (13,13)  {$T_3$};

			% \node (f0) at (2.5, 10)  {$F_0$};
			% \node (f1) at (6.5, 10)  {$F_1$};
			% \node (f2) at (10.5,10)  {$F_2$};
			% \node (f3) at (14.5,10)  {$F_3$};

			
			% de cima mais aberto q o de baixo 3.5
			% \node (t0) at (3.25, 13)  {$T_0$};
			% \node (t1) at (6.75, 13)  {$T_1$};
			% \node (t2) at (10.25,13)  {$T_2$};
			% \node (t3) at (13.75,13)  {$T_3$};
			...
			% parte de baixo mais larga3.5
			% \node (t0) at (4, 13)  {$T_0$};
			% \node (t1) at (7, 13)  {$T_1$};
			% \node (t2) at (10,13)  {$T_2$};
			% \node (t3) at (13,13)  {$T_3$};

			% \node (f0) at (3.25, 10)  {$F_0$};
			% \node (f1) at (6.75, 10)  {$F_1$};
			% \node (f2) at (10.25,10)  {$F_2$};
			% \node (f3) at (13.75,10)  {$F_3$};
		...
		\begin{center} \begin{tikzpicture}
			...
			\node (f10_) at (4.5+20,6)  {};
			\node (f11_) at (4.5+20,4)  {};
			\node (f12_) at (4.5+20,2)  {};
			\node (f13_) at (4.5+20,0)  {};
			...
			\node (t20_) at (12.5+20,6)  {};
			\node (t21_) at (12.5+20,4)  {};
			\node (t22_) at (12.5+20,2)  {};
			\node (t23_) at (12.5+20,0)  {};
			...
			\node (f0__) at (4 +40,10)  {};
			\node (f1__) at (7 +40,10)  {};
			\node (f2__) at (10+40,10)  {};
			\node (f3__) at (13+40,10)  {};

			\node (t10__) at (2.5+40,6)  {};
			\node (t11__) at (2.5+40,4)  {};
			\node (t12__) at (2.5+40,2)  {};
			\node (t13__) at (2.5+40,0)  {};	
			...
			\node (f20__) at (14.5+40,6)  {};
			\node (f21__) at (14.5+40,4)  {};
			\node (f22__) at (14.5+40,2)  {};
			\node (f23__) at (14.5+40,0)  {};
			...
			x2_/f20_,x2_/f21_,x2_/f22_,x2_/f23_}
			\draw[] (\from) -- (\to);

			\foreach \from/\to in {x1_/x2n_,x1_/f1_,x2n_/f2_}
			\draw[draw=red!60, line width=2.5pt] (\from) -- (\to);
			...
			x2__/f20__,x2__/f21__,x2__/f22__,x2__/f23__}
			\draw[] (\from) -- (\to);

			\foreach \from/\to in {x1__/x2n__,x1__/f1__,x2n__/f2__}
			\draw[draw=red!60, line width=2.5pt] (\from) -- (\to);
