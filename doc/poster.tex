...
[1.2cm]
\huge \textbf{Karina Suemi Awoki}\\[0.6cm] % Author(s)
\huge \textbf{Orientadora: Cristina Gomes Fernandes}\\[0.6cm] % Author(s)

\huge Universidade de São Paulo, Instituto de Matemática e Estatística\\[0.5cm] % University/organization
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\includegraphics[width=9cm]{imeusp.png}\
\includegraphics[width=9cm]{usp.png}\\
\end{minipage}
...
\begin{center}
\includegraphics[width=1.0\linewidth]{1subarvores_enraizadas.png}
\end{center}
...
\subsection*{Caso 1.}
    ...
    que~${\map_m^+(v)\in V(P)}$.
\begin{center}
\includegraphics[width=1.0\linewidth]{2mapeamento.png}
\end{center}
...
\subsection*{Caso 2.}
    ...
    \begin{center}
\includegraphics[width=1.0\linewidth]{3conjuntos_mapeamento.png}
\end{center}
...
\begin{center}
    \includegraphics[width=1.0\linewidth]{4conjuntos_mapeamento_f.png}
\end{center}
...
\medskip
\begin{center}
\includegraphics[width=0.8\linewidth]{arrumado.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\linewidth]{ult.png}
\end{center}
\noindent\rule[0.5ex]{\linewidth}{1pt}
