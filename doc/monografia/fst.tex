\section {Algoritmo FST para bissecção}
	...
	\begin{proof}
		...
		Sabemos que ao adicionar~$e = \{v_1,v_2\}$ em~$T$, o grau de~$v_1$
...
%         		&= \grau_T(v) \nonumber\\
	...
	\begin{proof}
		Utilizaremos indução para provar a primeira parte do
		...
		Portanto, a primeira parte do teorema é válida para~${i=1}$.


		\textbf{Caso~${\mathbf{i\ge 2}}$.} Provaremos que a 
		primeira parte 
		vale para~$i$, assumindo que ela é válida para~$i-1$.
