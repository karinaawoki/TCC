...
\section {Experimentos computacionais}
	...
	desenvolvidos em linguagem C em uma máquina com sistema operacional
	Linux Ubuntu versão**** com kernel ****, 
	sistema de operação 64 bits, processador *** com ** threads,
	8GB de memória RAM ****. 
	Para compilar os programas, foi utilizado o gcc versão ****
	As opções de compilação usadas foram -Wall -ansi, -pedantic, 
	-Wno-unused-result e -g. 
