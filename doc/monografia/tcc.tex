...
\AtBeginEnvironment{algorithm}{\setcounter{algoline}{14}}
...
\begin{abstract}
	...
	Além disso, o trabalho inclui ainda resultados de complexidade
	computacional para o problema da bissecção mínima.
...
\newpage
	...
	Obtivemos instâncias reais de grafos concedidas por Steffen Borgwardt e as
