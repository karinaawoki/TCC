...
\AtBeginEnvironment{algorithm}{\setcounter{algoline}{5}}
...
\section {Experimentos computacionais}
	...
	% \end{table}
		...
		\begin{table}[h]
		\centering
		\begin{tabular}{| c | >{\columncolor{blue!14}}P{2.1cm} | >{\columncolor{red!14}}P{2.1cm} | P{2.8cm} | >{\columncolor{blue!14}}P{2.6cm} | >{\columncolor{red!14}}P{2.6cm} |}
		%\begin{tabular}{c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c }
			\specialrule{1.7pt}{1pt}{1pt}
			$|V(T)|$ & $e_T(B,W)$ \textbf{FST} (pior~caso) & $e_T(B,W)$ \textbf{Jansen} (pior~caso) & nº de vezes que encontrou o ótimo & Tempo médio \textbf{FST} (segundos) & Tempo médio \textbf{Jansen}   (segundos) \\[10pt]
	...
	\bigskip
		...
		\begin{table}[h]
		\centering
		\begin{tabular}{| c | c | >{\columncolor{blue!14}}P{2.1cm} | >{\columncolor{red!14}}P{2.1cm} | >{\columncolor{blue!14}}P{2.6cm} | >{\columncolor{red!14}}P{2.6cm} | }
		%\begin{tabular}{c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c }
			\specialrule{1.7pt}{1pt}{1pt}
	...
	\bigskip
		...
		\begin{table}[htbf]
		\centering
		\begin{tabular}{| c | >{\columncolor{blue!14}}P{2.1cm} | >{\columncolor{red!14}}P{2.1cm} | >{\columncolor{blue!14}}P{2.6cm} | >{\columncolor{red!14}}P{2.6cm} |}
		%\begin{tabular}{c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c | >{\columncolor{blue!14}}c | >{\columncolor{red!14}}c }
			\specialrule{1.7pt}{1pt}{1pt}
